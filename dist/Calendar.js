...
module.exports = React.createClass({displayName: "exports",
  ...
  componentWillReceiveProps: function(nextProps) {
    this.setState({
      ...
      inputValue: nextProps.date
        ? moment(nextProps.date).format(this.state.format)
        : null
    });
  },
  ...
  render: function() {
    ...
    switch (this.state.currentView) {
      ...
      case 1:
        view = (
          React.createElement(MonthsView, {
            date: calendarDate, 
            setDate: this.setDate, 
            nextView: this.nextView, 
    ...
    var calendar = !this.state.isVisible
      ...
      : React.createElement("div", {className: "input-calendar-wrapper", onClick: this.calendarClick}, 
          view, 
          React.createElement("span", {className: "today-btn", onClick: this.todayClick}, "Today")
        );
    ...
    return (
      React.createElement("div", {className: "input-calendar"}, 
        React.createElement("input", {
          type: "text", 
          className: "input-calendar-value" + " " + this.props.inputFieldClass, 
